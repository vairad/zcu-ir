 ...
 * @version 27.3.2018
 */
public class Trigram extends BaseFeature implements Feature<Sentence> {

    private static final long serialVersionUID = 84002156988943223L;

    public Trigram(int threshold) {
        super(threshold);
    }
    ...
    public void extractFeature(ListIterator<Sentence> instances, FeatureVectorGenerator generator) {
        ...
        for (int i = 0; i < tokens.size() - 2; i++) {
            String word = tokens.get(i)+ "_" + tokens.get(i + 1) + "_" + tokens.get(i + 2);
